...
public class DBAcc {
	...
	private static String db2url = cfg.getvalue("db2url");
	private static String db2user = cfg.getvalue("db2user");
	private static String db2password = cfg.getvalue("db2password");
